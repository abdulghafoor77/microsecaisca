...
class ACME:
    ...
    def ai_vts(self, openapi_file, head_prompt):
        ...
        try:
            ...
            logger.info(f"Found {len(endpoints)} endpoints in OpenAPI file: {openapi_file}")
            ...
            for i, aprompt in enumerate(prompts):
                ...
                try:    
                    ...
                    logger.error("Error while processing individual endpoint", exc_info=True)
    ...
    def data_cleaner(self, input, i):
        ...
        for match in matches:
            exist = self.jsonHandler.find_index_of_plus(allItems, match.start(), match.end())
        ...
        try:
            ...
            logger.error("Invalid JSON format in test cases. Attempting recovery...", exc_info=False)
    ...
    def ret_env(self, jObj, fileDir):
        ...
        allVarVal = self.create_postman_environment_file("ACME Environment variables", unique_list)
...
if __name__ == "__main__":
    ...
    jsonHandler = JSONHandler()
    postman = jsonHandler.read_string("/home/chaincode/Desktop/acmeimp/tets/pre-postman.json");
    logger.info("Generating post-postman output with tagged test cases")
    post_postman = acme.tag_testcase(postman)
    print(post_postman)
