            ...
            try:
                with open(self.file_path, "r", encoding="utf-8") as f:
                    ...
                    if not isinstance(existing_data, list):
                        ...
                        raise ValueError("Existing JSON file is not a list. Cannot append.")
...
if __name__ == "__main__":
    ...
    file_path = f"/home/chaincode/Desktop/acmeimp/microsecai/result/8aeef669-5da5-4848-81be-488187f6cb31/1.json";
