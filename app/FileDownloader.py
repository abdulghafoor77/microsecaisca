...
class FileDownloader:
    def __init__(self, BASE_DIR):
        ...
        # Configure logging
        self.BASE_DIR = BASE_DIR#os.getenv("ACME_DATA_DIR", "/path/to/your/uuid/directories")
        logging.basicConfig(level=logging.INFO) 
        # Secure UUID pattern (accepts 32 chars or standard UUID format)
        self.UUID_PATTERN = re.compile(
            r"^[0-9a-fA-F]{32}$|^[0-9a-fA-F\-]{36}$"
        )       
    ...
    def get_file_from_uuid(self,uuid_value: str, file_key: str):
        ...
        try:
            ...
            logging.error(f"Directory traversal attempt detected for UUID: {uuid_value}")
