...
class AIEngine:
    ...
    def create_ai_cient(self):
        ...
        client = AzureOpenAI(api_version=self.AZURE_OPENAI_API_VERSION, azure_endpoint=self.AZURE_OPENAI_ENDPOINT, api_key=self.AZURE_OPENAI_KEY, )
        return client;
    ...
    def generate_with_llm(self, prompt, client):
        ...
        messages=[
            ...
            {"role": "user", "content": "Generate only postman collection without any other description and explaination"}
        ],
        temperature=0.7,
        max_tokens=5000,
        )
