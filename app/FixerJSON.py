...
if __name__ == "__main__":
    ...
    contents = fixerJSON.read_string("/home/chaincode/Desktop/acmeimp/microsecai/output/repeat.json")
    new_json_str = fixerJSON.eliminate_repeat(contents)
    fixerJSON.validate_json_string(new_json_str)
    fixerJSON.save_string("/home/chaincode/Desktop/acmeimp/microsecai/output/replaced.json",new_json_str)